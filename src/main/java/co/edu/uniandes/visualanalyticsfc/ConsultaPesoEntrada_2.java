 ...
 * @author Deisy
 */
@WebServlet(name = "ConsultaPesoEntrada_2", urlPatterns = {"/ConsultaPesoEntrada_2"})
public class ConsultaPesoEntrada_2 extends HttpServlet {
    ...
    private List<PromYearDTO> ProcesarMedidas(List<VariableFilterDTO> filters) {
        ...
        String map = "function() {\n"
                ...
                + "    }\n"
                + "    if(this.PesosalidaPC_Normalizado){\n"
                + "        emit(this.ANOCAT+'-'+this.sexo+'-3', this.PesosalidaPC_Normalizado);\n"
                + "    }\n"
                + "}";
    ...
    private List<PromYearDTO> ProcesarMedidasDetalle(List<VariableFilterDTO> filters) {
        ...
        for(Document doc:docMedidas){
            try{
                ...
                mapa.put("pesoSalida", convertirD(doc.get("PesosalidaPC_Normalizado")));
